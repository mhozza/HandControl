...
# Generated by qmake (2.01a) (Qt 4.7.4) on: ut nov 8 21:51:53 2011
...
LINK          = g++
LFLAGS        = 
LIBS          = $(SUBLIBS)  -L/usr/lib/i386-linux-gnu -lv4l2 -lXtst -lQtGui -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
...
SOURCES       = main.cpp \
		...
		utils.cpp \
		hcimage.cpp moc_mainwindow.cpp \
		moc_webcam.cpp \
