...
# Generated by qmake (2.01a) (Qt 4.7.2) on: Sat Jun 11 13:52:05 2011
...
SOURCES       = main.cpp \
		...
		exceptions.cpp \
		imageprocessor.cpp \
		handdetector.cpp moc_mainwindow.cpp \
		moc_webcam.cpp
OBJECTS       = main.o \
		mainwindow.o \
		webcam.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/HandControl1.0.0/ && $(COPY_FILE) --parents mainwindow.h webcam.h imageconvert.h merror.h exceptions.h imageprocessor.h handdetector.h .tmp/HandControl1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp webcam.cpp merror.cpp imageconvert.cpp exceptions.cpp imageprocessor.cpp handdetector.cpp .tmp/HandControl1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/HandControl1.0.0/ && (cd `dirname .tmp/HandControl1.0.0` && $(TAR) HandControl1.0.0.tar HandControl1.0.0 && $(COMPRESS) HandControl1.0.0.tar) && $(MOVE) `dirname .tmp/HandControl1.0.0`/HandControl1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/HandControl1.0.0
