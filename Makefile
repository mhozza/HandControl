...
# Generated by qmake (2.01a) (Qt 4.7.2) on: Mon Jun 27 13:31:44 2011
...
SOURCES       = main.cpp \
		...
		gesturemoveup.cpp \
		gesturemovedown.cpp \
		onscreendisplayform.cpp moc_mainwindow.cpp \
		moc_webcam.cpp \
