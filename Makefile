...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Thu Apr 5 13:48:20 2012
...
SOURCES       = main.cpp \
		...
		kalmanfilter.cpp moc_mainwindow.cpp \
		moc_webcam.cpp \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/HandControl1.0.0/ && $(COPY_FILE) --parents mainwindow.h webcam.h imageconvert.h merror.h exceptions.h imageprocessor.h handrecognizer.h NeuralNet/perceptron.h NeuralNet/neuralnetwork.h NeuralNet/neurallayer.h NeuralNet/continuous_perceptron.h gesturerecognizer.h gesture.h gesturemoveleft.h gesturemoveright.h xfunc.h gesturemoveup.h gesturemovedown.h onscreendisplayform.h utils.h hcimage.h NeuralNet/distributedneurallayer.h NeuralNet/distributedneuralnetwork.h kalmanfilter.h .tmp/HandControl1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp webcam.cpp merror.cpp imageconvert.cpp exceptions.cpp imageprocessor.cpp handrecognizer.cpp NeuralNet/perceptron.cpp NeuralNet/neuralnetwork.cpp NeuralNet/neurallayer.cpp NeuralNet/continuous_perceptron.cpp gesturerecognizer.cpp gesture.cpp gesturemoveleft.cpp gesturemoveright.cpp xfunc.cpp gesturemoveup.cpp gesturemovedown.cpp onscreendisplayform.cpp utils.cpp hcimage.cpp NeuralNet/distributedneurallayer.cpp NeuralNet/distributedneuralnetwork.cpp kalmanfilter.cpp .tmp/HandControl1.0.0/ && $(COPY_FILE) --parents mainwindow.ui onscreendisplayform.ui .tmp/HandControl1.0.0/ && (cd `dirname .tmp/HandControl1.0.0` && $(TAR) HandControl1.0.0.tar HandControl1.0.0 && $(COMPRESS) HandControl1.0.0.tar) && $(MOVE) `dirname .tmp/HandControl1.0.0`/HandControl1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/HandControl1.0.0
