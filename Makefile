...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Wed May 30 18:10:39 2012
# Project:  HandControl.pro
# Template: app
# Command: /usr/bin/qmake-qt4 -spec /usr/share/qt4/mkspecs/linux-g++ -o Makefile HandControl.pro
#############################################################################
...
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/lib/i386-linux-gnu -lv4l2 -lXtst -lfftw3 -lX11 -lQtGui -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
...
SOURCES       = main.cpp \
		...
		NeuralNet/distributedrecurrentlayer.cpp moc_mainwindow.cpp \
		moc_webcam.cpp \
...
OBJECTS       = main.o \
		...
		elmannetwork.o \
		recurrentlayer.o \
		recurrentperceptron.o \
		recurrentnetwork.o \
		distributedrecurrentnetwork.o \
		distributedrecurrentlayer.o \
		moc_mainwindow.o \
		moc_webcam.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/HandControl1.0.0/ && $(COPY_FILE) --parents mainwindow.h webcam.h imageconvert.h merror.h exceptions.h imageprocessor.h handrecognizer.h NeuralNet/perceptron.h NeuralNet/neuralnetwork.h NeuralNet/neurallayer.h NeuralNet/continuous_perceptron.h gesturerecognizer.h gesture.h gesturemoveleft.h gesturemoveright.h xfunc.h gesturemoveup.h gesturemovedown.h onscreendisplayform.h utils.h hcimage.h NeuralNet/distributedneurallayer.h NeuralNet/distributedneuralnetwork.h kalmanfilter.h colorimage.h grayscaleimage.h color.h NeuralNet/elmannetwork.h NeuralNet/recurrentlayer.h NeuralNet/recurrentperceptron.h NeuralNet/recurrentnetwork.h NeuralNet/distributedrecurrentnetwork.h NeuralNet/distributedrecurrentlayer.h .tmp/HandControl1.0.0/ && $(COPY_FILE) --parents resource.qrc .tmp/HandControl1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp webcam.cpp merror.cpp imageconvert.cpp exceptions.cpp imageprocessor.cpp handrecognizer.cpp NeuralNet/perceptron.cpp NeuralNet/neuralnetwork.cpp NeuralNet/neurallayer.cpp NeuralNet/continuous_perceptron.cpp gesturerecognizer.cpp gesture.cpp gesturemoveleft.cpp gesturemoveright.cpp xfunc.cpp gesturemoveup.cpp gesturemovedown.cpp onscreendisplayform.cpp utils.cpp NeuralNet/distributedneurallayer.cpp NeuralNet/distributedneuralnetwork.cpp kalmanfilter.cpp colorimage.cpp grayscaleimage.cpp color.cpp NeuralNet/elmannetwork.cpp NeuralNet/recurrentlayer.cpp NeuralNet/recurrentperceptron.cpp NeuralNet/recurrentnetwork.cpp NeuralNet/distributedrecurrentnetwork.cpp NeuralNet/distributedrecurrentlayer.cpp .tmp/HandControl1.0.0/ && $(COPY_FILE) --parents mainwindow.ui onscreendisplayform.ui .tmp/HandControl1.0.0/ && (cd `dirname .tmp/HandControl1.0.0` && $(TAR) HandControl1.0.0.tar HandControl1.0.0 && $(COMPRESS) HandControl1.0.0.tar) && $(MOVE) `dirname .tmp/HandControl1.0.0`/HandControl1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/HandControl1.0.0
...
grayscaleimage.o: grayscaleimage.cpp grayscaleimage.h \
		hcimage.h \
		utils.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o grayscaleimage.o grayscaleimage.cpp

color.o: color.cpp color.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o color.o color.cpp

elmannetwork.o: NeuralNet/elmannetwork.cpp NeuralNet/elmannetwork.h \
		NeuralNet/neuralnetwork.h \
		NeuralNet/neurallayer.h \
		NeuralNet/continuous_perceptron.h \
		NeuralNet/perceptron.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o elmannetwork.o NeuralNet/elmannetwork.cpp

recurrentlayer.o: NeuralNet/recurrentlayer.cpp NeuralNet/recurrentlayer.h \
		NeuralNet/neurallayer.h \
		NeuralNet/continuous_perceptron.h \
		NeuralNet/perceptron.h \
		NeuralNet/recurrentperceptron.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o recurrentlayer.o NeuralNet/recurrentlayer.cpp

recurrentperceptron.o: NeuralNet/recurrentperceptron.cpp NeuralNet/recurrentperceptron.h \
		NeuralNet/continuous_perceptron.h \
		NeuralNet/perceptron.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o recurrentperceptron.o NeuralNet/recurrentperceptron.cpp

recurrentnetwork.o: NeuralNet/recurrentnetwork.cpp NeuralNet/recurrentnetwork.h \
		NeuralNet/neuralnetwork.h \
		NeuralNet/neurallayer.h \
		NeuralNet/continuous_perceptron.h \
		NeuralNet/perceptron.h \
		NeuralNet/recurrentlayer.h \
		NeuralNet/recurrentperceptron.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o recurrentnetwork.o NeuralNet/recurrentnetwork.cpp

distributedrecurrentnetwork.o: NeuralNet/distributedrecurrentnetwork.cpp NeuralNet/distributedrecurrentnetwork.h \
		NeuralNet/recurrentnetwork.h \
		NeuralNet/neuralnetwork.h \
		NeuralNet/neurallayer.h \
		NeuralNet/continuous_perceptron.h \
		...
		NeuralNet/distributedneurallayer.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o distributedrecurrentnetwork.o NeuralNet/distributedrecurrentnetwork.cpp

distributedrecurrentlayer.o: NeuralNet/distributedrecurrentlayer.cpp NeuralNet/distributedrecurrentlayer.h \
		NeuralNet/recurrentlayer.h \
		NeuralNet/neurallayer.h \
		NeuralNet/continuous_perceptron.h \
		NeuralNet/perceptron.h \
		NeuralNet/recurrentperceptron.h \
		NeuralNet/distributedneurallayer.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o distributedrecurrentlayer.o NeuralNet/distributedrecurrentlayer.cpp
