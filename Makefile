...
# Generated by qmake (2.01a) (Qt 4.7.0) on: Wed Nov 17 12:12:27 2010
...
SOURCES       = main.cpp \
		...
		merror.cpp \
		imageconvert.cpp \
		exceptions.cpp moc_mainwindow.cpp \
		moc_webcam.cpp
OBJECTS       = main.o \
		mainwindow.o \
		webcam.o \
