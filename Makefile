...
# Generated by qmake (2.01a) (Qt 4.7.2) on: Mon Jun 20 19:38:56 2011
...
SOURCES       = main.cpp \
		...
		NeuralNet/continuous_perceptron.cpp moc_mainwindow.cpp \
		moc_webcam.cpp
OBJECTS       = main.o \
		mainwindow.o \
		webcam.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/HandControl1.0.0/ && $(COPY_FILE) --parents mainwindow.h webcam.h imageconvert.h merror.h exceptions.h imageprocessor.h handrecognizer.h NeuralNet/perceptron.h NeuralNet/neuralnetwork.h NeuralNet/neurallayer.h NeuralNet/continuous_perceptron.h .tmp/HandControl1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp webcam.cpp merror.cpp imageconvert.cpp exceptions.cpp imageprocessor.cpp handrecognizer.cpp NeuralNet/perceptron.cpp NeuralNet/neuralnetwork.cpp NeuralNet/neurallayer.cpp NeuralNet/continuous_perceptron.cpp .tmp/HandControl1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/HandControl1.0.0/ && (cd `dirname .tmp/HandControl1.0.0` && $(TAR) HandControl1.0.0.tar HandControl1.0.0 && $(COMPRESS) HandControl1.0.0.tar) && $(MOVE) `dirname .tmp/HandControl1.0.0`/HandControl1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/HandControl1.0.0
